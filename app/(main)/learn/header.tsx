    ...
    <div className="top-[60px] px-8 py-4 bg-green-700 rounded-xl flex items-center justify-between w-full text-neutral-100 z-40 lg:sticky lg:top-[40px]">
      <div className="flex flex-col gap-2">
        <div className="flex gap-1">
          <h2 className="text-[0.875rem] font-semibold lg:text-md"> {section}, </h2>
          <h2 className="text-[0.875rem] font-semibold lg:text-md">{unit}</h2>
        </div>
        <h1 className="font-bold text-xl lg:text-3xl">{theme}</h1>
      </div>
      <Link href={"/sessions"}>
        <Button size="sm" variant={"secondary"} className="bg-transparent border-green-900/15 lg:flex hover:bg-green-600/50 lg:h-14 border-2 border-b-4 active-b-2">
