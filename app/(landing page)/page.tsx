...
const sessions = [
  {
    label: "A",
    sub: "Iniciante",
    p: "Básico e essencial, mas ainda exclui alguns usuários.",
  },
  {
    label: "AA",
    sub: "Intermediário",
    p: "Recomendado, equilibrado entre inclusão e facilidade de implementação.",
  },
  {
    label: "AAA",
    sub: "Avançado",
    p: "Mais inclusivo, porém complexo e não obrigatório.",
  },
];
...
export default function Home() {
  return (
    <main className="flex flex-col space-y-5">
      {/* Hero Action */}
      <section
        className="flex mt-10 w-full justify-center lg:justify-between items-center"
        id="home"
        role="banner"
      >
        <div className="space-y-4 w-full 2xl:w-[57.9375rem] lg:w-6/12">
          <h1
            className="font-bold text-primary text-4xl lg:text-6xl"
            tabIndex={0}
          >
            Que tal tornar a web mais{" "}
          ...
          <p className="text-xl">
            Dê seus primeiros passos no desenvolvimento web acessível com
            modoke.
          </p>
        ...
        <div
          className="hidden 2xl:w-full lg:flex justify-end w-6/12"
          aria-hidden="true"
        >
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/modoke/Hero+-+Modoke+saindo+do+PC.png"
            }
            alt="Person working on a computer with accessibility features"
            width={822}
            height={822}
          />
        </div>
      ...
      >
        <div className="space-y-9 mt-60 my-48 w-[57.9375rem] flex flex-col justify-center items-center">
          <h1
            className="font-bold text-primary text-3xl lg:text-7xl"
            tabIndex={0}
          >
            O que é{" "}
            <span className="relative inline-block">
          ...
          <p className="text-xl text-center">
            No desenvolvimento web, acessibilidade envolve criar aplicações que
            sejam o mais inclusivas possível, independentemente das capacidades
            físicas e cognitivas do usuário final e da maneira como ele acessa a
            web.
          </p>
          <Link href="/signup/test">
            <Button
        ...
        <div className="absolute inset-0 pointer-events-none">
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-a.png"
            }
            alt=""
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-aaa.png"
            }
            alt=""
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-beInclusive.png"
            }
            alt=""
      ...
      <section
        className="flex flex-col lg:flex-row w-full justify-between items-center min-h-[40rem]"
        role="complementary"
      >
        <div className="mr-12 space-y-9 mt-20 mb-60 w-6/12 flex flex-col justify-center items-start">
          ...
          <p className="text-lg">
            Desenvolver aplicações web acessíveis não só torna a World Wide Web
            mais inclusiva para todos, mas também se destaca como um diferencial
            valorizado por empresas de grande porte para seus desenvolvedores.
          </p>
        </div>
      ...
      <section className="relative flex w-full justify-center items-center">
        <div className="space-y-9 mt-60 my-48 w-[65rem] flex flex-col justify-center items-center">
          <span className="text-primary text-5xl text-center font-semibold">
            “O poder da Web está na sua universalidade. O acesso por todas as
            pessoas, não obstante a sua deficiência, é um aspecto essencial.”
          </span>
        ...
        <div className="absolute inset-0 pointer-events-none">
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-code.png"
            }
            alt=""
            className="absolute top-10 -left-20 w-50 h-50 transform -translate-x-20 -translate-y-15 -rotate-12"
            width={200}
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-WCAG.png"
            }
            alt=""
            className="absolute top-0 right-0 w-50 h-50 transform translate-x-14 rotate-12"
            width={200}
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-som.png"
            }
            alt=""
            className="absolute bottom-10 left-0 w-50 h-50 transform -translate-x-10 -rotate-12"
            width={200}
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-web4all.png"
            }
            alt=""
            className="absolute bottom-10 right-10 w-50 h-50 transform translate-x-10 rotate-12"
            width={200}
      ...
      {/* O que é Modoke? */}
      <section
        className="flex w-full justify-between items-center min-h-[40rem]"
        id="modoke"
      >
        <div className="mr-12 space-y-9 mt-20 mb-60 w-6/12 flex flex-col justify-center items-start">
          <h1 className="font-bold text-primary text-6xl">
          ...
          <p className="text-lg">
            Modoke é sua companhia, ele visa tornar a web um lugar mais
            inclusivo. Aqui, Modoke te ensina os princípios e diretrizes da
            acessibilidade de um jeito que você pode aplicar diretamente nos
            seus projetos. Vamos descobrir como funciona?
          </p>
          <span className="text-sm">
            * Modoke vem do japonês “modoken”, que significa cão guia.
          </span>
        </div>

        <div
          className="flex justify-center items-center w-4/12"
          aria-hidden="true"
        >
          <Image
            src={
            ...
            alt="Illustration of Modoke guiding users through accessibility"
            width={822}
            height={822}
          />
        </div>
      ...
      <section className="relative flex w-full justify-center items-center">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <Image
            src={
              "https://projeto-modoke.s3.us-east-2.amazonaws.com/badges/badge-ace.png"
            }
            alt=""
        ...
        <div className="space-y-9 my-28 w-[57.9375rem] flex flex-col justify-center items-center">
          ...
          >
            <Image
              ...
              alt="Illustration of Modoke with badges and certificates"
              width={522}
              height={522}
            />
          </div>
